...
public class UserController {
	...
	public String user_login_action_post(@ModelAttribute(value = "fuser") User user, HttpServletRequest request)
			throws Exception {
		String forwardPath = "";
...
@RequestMapping(value = "/user_logout_action")
	...
	@RequestMapping(value = { "/user_modify_form", "/user_login_action", "/user_write_action", "/user_modify_action",
			"/user_remove_action" }, method = RequestMethod.GET)
	public String user_action_get() {
		return "redirect:user_main";
	}

	/*
	 * /user_main /user_write_form /user_write_action /user_login_form
	 * /user_login_action /user_logout_action /user_view /user_modify_form
