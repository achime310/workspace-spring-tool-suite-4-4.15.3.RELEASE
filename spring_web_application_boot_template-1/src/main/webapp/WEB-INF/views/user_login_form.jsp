...
<%@page import="com.itwill.user.UserInfo"%>
								...
								<table border="0" cellpadding="0" cellspacing="1"
									...
									<tr>
										...
										<td width=490 align="left" bgcolor="ffffff"
											...
											style="width: 150" name="user_id" value="${fuser.user_id}">&nbsp;&nbsp;<font color="red">${msg1}</font></td>
									</tr>
									<tr>
										<td width=100 align=center bgcolor="E6ECDE" height="22">비밀번호</td>
										<td width=490 align="left" bgcolor="ffffff"
											style="padding-left: 10px"><input type="password"
											style="width: 150" name="user_pw" value="${fuser.user_pw}">&nbsp;&nbsp;<font color="red">${msg2}</font></td>
									</tr>
								</table>
							</form> <br />
							<table border="0" cellpadding="0" cellspacing="1">
