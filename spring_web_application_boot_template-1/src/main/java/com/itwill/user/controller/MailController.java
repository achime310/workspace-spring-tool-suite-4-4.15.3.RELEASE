...
import com.itwill.user.MailService;
...
public class MailController {
	...
	public Map mailSener(@RequestParam(value="user_id") String user_id, @RequestParam(value="invi_email")String invi_email) throws Exception{
		...
		try {
			...
			url="";
			msg="";
			b=mailService.mailsender(user_id,invi_email);
		} catch (Exception e) {
			code=2;
			url="";
			msg="메일 실패";
