...
public class ResponseController {
	/* #################### forward #################### */
	/*
	 * forwarding view 객체반환
	 * 	-> DispatcherServlet이 view Resolver를 사용할 필요가 없어짐
	 */
	...
	/* #################### View객체가 직접 xml(json, text)출력[XMLView] #################### */
	/*
	 * xml출력 view object반환(viewResolver필요없도록)
	 */
	...
	public String reponse_xml_view_name(Model model) {
		List<String> friendList = new ArrayList<String>();
		friendList.add("최서일");
		friendList.add("최서이");
		friendList.add("최서삼");
