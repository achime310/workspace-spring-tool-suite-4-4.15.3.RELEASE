...
function user_main_content(){
			//template literal -> javaScript변수값을 넣을 수 있음.
	return `<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
				...
				<embed src="image/enter2.png" scale="exactfit" play="true"
...
function user_write_form_content(fUser,msg) {
					...
					<tr>
						<td>
								...
								<table border="0" cellpadding="0" cellspacing="1" width="590"
									...
									<tr>
										...
										<td width=490 bgcolor="ffffff" style="padding-left: 10px" align="left">
											<input type="text" style="width: 150px" name="userId" value="${fUser.userId}">&nbsp;&nbsp;
							...
							<table border=0 cellpadding=0 cellspacing=1>
								<tr>
									<td align=center>
									<input type="button" value="회원 가입" id="btn_user_create_action"> &nbsp; 
									<input type="button" value="메인" id="btn_user_main">
									</td>
								</tr>
							</table>
