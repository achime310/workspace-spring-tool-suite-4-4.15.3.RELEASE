...
public class UserDaoImplMyBatisMapperInterfaceTestAnnotationMain {

	public static void main(String[] args) throws Exception{
		System.out.println("----Spring Container초기화시작[ApplicationContext객체생성시작]");
		ApplicationContext applicationContext=
				new ClassPathXmlApplicationContext("/com/itwill/user/user_dao_mybatis_mapper_interface_annotation.xml");
		...
		User user = new User("시오영3", "jdbc비번", "jdbc이름", "jdbc@dot.com");
