...
public class StudentDaoMain {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Student student = new Student(null, "시퀀스", "seq@dot.com", new Date(), null);
		System.out.println(studentDao.insertStudentBySequence1(student));
		System.out.println("insert studId = " + student.getStudId());
		System.out.println("---------insertStudentBySequence2--------------------");
		System.out.println(studentDao.insertStudentBySequence2(new Student(null, "시퀀스", "seq@dot.com", new Date(), null)));
		/**************************************************
		 UPDATE
		 ***************************************************/
		/*
		...
		student= studentDao.findStudentById(5);
