...
public class Guest {
	...
	@Autowired
	public Guest(@Value(value = "199") int guest_no,
				@Value(value = "이름") String guest_name,
				@Value(value = "2022-05-11") String guest_date,
				@Value(value = "이메일") String guest_email,
				@Value(value = "홈페이지") String guest_homepage,
	...
	@Autowired
	@Value(value = "컨텐트")	//이렇게 안하고 property를 뽑아서씀
